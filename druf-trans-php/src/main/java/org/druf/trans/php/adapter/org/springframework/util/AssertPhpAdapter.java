 ...
 */
package org.druf.trans.php.adapter.org.springframework.util;
...
public class AssertPhpAdapter extends BasicPhpAdapter
{
	@Override
	public VisitResult		processMethodInvocation(VisitResult path, Method method, List<VisitResult> arguments, MethodInvocationTree node, Trees trees)
	{
		...
		if (method.getName().equals("isTrue")) {
			sb.append("\\org\\druf\\tenv\\DAssert::assertTrue(");
