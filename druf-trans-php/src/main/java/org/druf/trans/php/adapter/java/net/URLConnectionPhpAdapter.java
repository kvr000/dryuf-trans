 ...
 */
package org.druf.trans.php.adapter.java.net;
...
public class URLConnectionPhpAdapter extends WrongPhpAdapter
{
	@Override
	public VisitResult		processMethodInvocation(VisitResult path, Method method, List<VisitResult> arguments, MethodInvocationTree node, Trees trees)
	{
		...
		if (method.getName().equals("guessContentTypeFromName")) {
			sb.append("\\org\\druf\\text\\util\\MimeType::guessContentTypeFromName(");
