 ...
 */
package org.druf.trans.php.adapter.org.apache.commons.lang3;
...
public class ObjectUtilsPhpAdapter extends BasicPhpAdapter
{
	@Override
	public VisitResult		processMethodInvocation(VisitResult path, Method method, List<VisitResult> arguments, MethodInvocationTree node, Trees trees)
	{
		...
		if (method.getName().equals("defaultIfNull")) {
			sb.append("\\org\\druf\\core\\Druf::defvalue(");
