 ...
 */
package net.dryuf.trans.php.adapter.net.dryuf.web.oper;
...
public class ObjectOperMethodPhpAdapter extends BasicPhpAdapter
{
	@Override
	public VisitResult		processFieldAccess(VisitResult path, Field field, MemberSelectTree node, Trees trees)
	{
		if (
				field.getName().equals("LIST")
				) {
			return new VisitResult(visitor.translateClassIdentifier(field.getDeclaringClass().getName())+"::LISTING");
		}
