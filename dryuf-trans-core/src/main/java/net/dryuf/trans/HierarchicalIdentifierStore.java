...
public class HierarchicalIdentifierStore extends AbstractIdentifierStore
{
	public				HierarchicalIdentifierStore(@NotNull IdentifierStore parent)
	{
		this.parent = parent;
	}

	@Override
	protected IdentifierDef		findFallback(String name)
	{
